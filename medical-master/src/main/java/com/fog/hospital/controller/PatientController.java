...
import com.fog.hospital.mapper.OrderMapper;
import com.fog.hospital.pojo.Orders;
import com.fog.hospital.pojo.Patient;
import com.fog.hospital.service.DoctorService;
import com.fog.hospital.service.OrderService;
import com.fog.hospital.service.PatientService;
import com.fog.hospital.utils.JwtUtil;
import com.fog.hospital.utils.PdfUtil;
...
public class PatientController {
    ...
    public ResponseData getPatientInfo(@PathVariable String name) {
        Patient patient = patientService.getPatientByName(name);
        System.out.println(patient);
        if (patient == null) {
            return ResponseData.fail("没找到");
        }
        return ResponseData.success("患者信息获取成功",patient);
    }
}
