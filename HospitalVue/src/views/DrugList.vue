    ...
    <div>
        ...
        <el-card>
            ...
            <el-table :data="drugData" stripe style="width: 100%" border>
                <el-table-column label="编号" align="center" prop="drId"></el-table-column>
                <el-table-column label="名称" align="center" prop="drName"></el-table-column>
                <el-table-column
                    label="剩余数量"
                    prop="drNumber"
                    align="center"
                ></el-table-column>
                <el-table-column label="单位" align="center" prop="drUnit"></el-table-column>
                <el-table-column label="单价" align="center" prop="drPrice"></el-table-column>
                <el-table-column
                    label="出版商"
                    align="center"
                    prop="drPublisher"
