...
<!-- 管理员-医生管理 -->
    <el-card>
        ...
        <el-row type="flex">
            ...
            <el-col :span="4">
                <el-button type="primary" @click="addFormVisible = true"
                    ...
                    <i class="el-icon-circle-plus-outline" style="font-size: 22px;">
                    </i>入职添加医生
                </el-button
                >
            </el-col>
           ...
           <el-col :span="2">
                <el-upload
                    ...
                    :file-list="fileList"
                >
                    <el-button size="small" type="success" style="height: 40px;">一键导入</el-button>
                </el-upload>
            </el-col>

            <el-col :span="2">
                <el-button size="small" type="success" @click="exportDoctors" style="height: 40px;"
                    >一键导出</el-button
                ></el-col
            >
        </el-row>
        ...
        <el-table :data="doctorData" stripe style="width: 100%" border>
            ...
            <el-table-column prop="dCard" label="证件号" width="180" align="center">
            </el-table-column>
            <el-table-column prop="dPhone" label="手机号" width="120" align="center">
            </el-table-column>
            <el-table-column prop="dEmail" label="邮箱" width="150" align="center">
            </el-table-column>
            <el-table-column prop="dAvgStar" label="评分" width="50" align="center">
            </el-table-column>
            <el-table-column prop="dPrice" label="挂号费" width="80" align="center">
            </el-table-column>
            ...
            <el-table-column label="操作" width="140" fixed="right" align="center">
                <template slot-scope="scope">
                    <el-button type="success" icon="el-icon-edit" @click="modifyDialog(scope.row.dId)" ></el-button>
                    <el-button type="danger" icon="el-icon-delete"  @click="deleteDialog(scope.row.dId)" style="margin-left: 1px;"></el-button>
                </template>
            </el-table-column>
        </el-table>
