...
<!-- 病人列表 -->
    ...
    <el-card>
        ...
        <el-table :data="patientData" stripe style="width: 100%" border>
            <el-table-column prop="pId" label="账号" width="100" align="center">
            </el-table-column>
            <el-table-column prop="pName" label="姓名" width="80" align="center">
            </el-table-column>
            <el-table-column prop="pGender" label="性别" width="60" align="center">
            </el-table-column>
            <el-table-column prop="pAge" label="年龄/岁" width="80" align="center">
            </el-table-column>
            ...
            <el-table-column prop="pEmail" label="邮箱"  width="170" align="center">
            </el-table-column>
