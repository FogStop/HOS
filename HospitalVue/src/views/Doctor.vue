      ...
      <el-aside width="220px" class="nav-sidebar">
        ...
        >
          ...
          >
            ...
            <span class="nav-text">今日挂号列表</span>
          </el-menu-item>
          ...
          >
            ...
            <span class="nav-text">历史患者列表</span>
          </el-menu-item>
...
<!--            <span class="nav-text">住院申请管理</span>-->
<!--          </el-menu-item>-->
          ...
          >
            ...
            <span class="nav-text">个人信息展示</span>
          </el-menu-item>
        </el-menu>
      </el-aside>
